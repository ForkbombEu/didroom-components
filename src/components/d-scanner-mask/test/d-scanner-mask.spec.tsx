      ...
      <d-scanner-mask>
        <mock:shadow-root>
          <div class="fixed flex flex-col h-screen items-center justify-center left-0 top-0 visible w-full z-40">
            <div class="!bg-opacity-70 bg-on-alt flex-grow min-h-24 w-full"></div>
            <div class="flex h-72 w-full">
              <div class="!bg-opacity-70 bg-on-alt flex-grow h-full max-w-1/4"></div>
              ...
              <div class="!bg-opacity-70 bg-on-alt flex-grow h-full"></div>
            </div>
            <div class="!bg-opacity-70 bg-on-alt flex flex-col flex-grow space-y-2 w-full">
              <div class="justify-center text-center">
                <d-page-description></d-page-description>
              </div>
              <div class="flex justify-center text-center w-full">
                <d-button aria-hidden="" color="primary">
                  Cancel
                </d-button>
              </div>
           </div>
